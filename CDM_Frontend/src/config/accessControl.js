...
export const NAVIGATION_ITEMS = Object.freeze([
  ...
  { name: 'guest-profile', label: 'My Profile', path: '/profile', icon: 'PR', roles: ROUTE_ROLES['guest-profile'] },
  {
    ...
    children: [
      { name: 'student-document-requests', label: 'Document Requests', path: '/document-requests', roles: ROUTE_ROLES['student-document-requests'] },
      { name: 'student-document-appointments', label: 'Appointments', path: '/document-requests/appointments', roles: ROUTE_ROLES['student-document-appointments'] },
      { name: 'registrar-document-types', label: 'Document Types', path: '/registrar/document-types', roles: ROUTE_ROLES['registrar-document-types'] },
      { name: 'registrar-document-requests', label: 'Document Requests', path: '/registrar/document-requests', roles: ROUTE_ROLES['registrar-document-requests'] },
      { name: 'registrar-document-appointments', label: 'Appointments', path: '/registrar/appointments', roles: ROUTE_ROLES['registrar-document-appointments'] },
      { name: 'registrar-document-request-history', label: 'History', path: '/registrar/document-requests/history', roles: ROUTE_ROLES['registrar-document-request-history'] },
    ],
  },
