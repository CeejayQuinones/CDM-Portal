...
const submit = async () => {
  ...
  try {
    ...
    const destination =
      typeof route.query.redirect === 'string' ? route.query.redirect : dashboardForRole(authStore.currentRole)
...
<template>
  <section class="login-card" aria-labelledby="login-title">
    ...
    <p v-if="route.query.registered" class="registration-success" role="status">
    ...
    <form novalidate @submit.prevent="submit">
      ...
      <p class="register-link">
        Need an account?
        <RouterLink :to="{ name: 'register' }">Register as a Guest</RouterLink>
      </p>
    </form>
  </section>
</template>
