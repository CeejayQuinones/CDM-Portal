...
const submit = async () => {
  ...
  try {
    ...
    formError.value = JSON.stringify(error.response?.data) || error.message
  } finally {
    ...
    <form novalidate @submit.prevent="submit">
      ...
      <div class="form-grid">
        <label>
          ...
          <small v-if="errors.first_name">{{ errors.first_name }}</small>
        </label>
        <label>
          Last name
          <input v-model="form.last_name" autocomplete="family-name" />
          <small v-if="errors.last_name">{{ errors.last_name }}</small>
        </label>
      </div>
      <label>
        Username
