...
<style scoped>section{border:1px solid var(--student-border, #d7dfd6);border-radius:8px;padding:16px;background:var(--student-surface, #fff)}header{display:flex;justify-content:space-between;gap:12px;align-items:center}h2{margin:0}.session{display:grid;gap:3px;padding:10px 0;border-top:1px solid var(--student-border, #e5e9e5)}.session span,small{color:var(--student-muted, #52605a)}.error{color:var(--student-danger, #a8291f)}button{border:1px solid #106a2e;background:var(--student-surface, #fff);color:var(--student-accent, #106a2e);border-radius:5px;padding:7px 10px;font-weight:700}</style>
