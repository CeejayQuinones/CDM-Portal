...
const isChildActive = (item) => item.children?.some((child) => child.path === route.path)
...
const iconPath = (name) => ({
  ...
  monitoring: 'M4 19V5M8 15v4M12 9v10M16 12v7M20 5v14', 'document-requests-menu': 'M7 3h7l4 4v14H7zM14 3v5h5M10 12h5M10 16h5',
      ...
      <template v-for="item in menuItems" :key="item.name">
        <div v-if="item.children" class="nav-group">
          <button
            ...
            :class="{ 'is-active': isChildActive(item) || isExpanded(item.name) }"
